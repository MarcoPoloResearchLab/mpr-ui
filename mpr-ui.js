...
function normalizeStandaloneThemeToggleOptions(rawOptions) {
  ...
  var HEADER_STYLE_MARKUP =
    ...
    "." +
    HEADER_ROOT_CLASS +
    "__inner{max-width:1080px;margin:0 auto;padding:calc(0.75rem * var(--mpr-header-scale,1)) calc(1.5rem * var(--mpr-header-scale,1));display:flex;align-items:center;gap:calc(1.5rem * var(--mpr-header-scale,1))}" +
    "." +
    HEADER_ROOT_CLASS +
    "__brand{font-size:calc(1.05rem * var(--mpr-header-scale,1));font-weight:700;letter-spacing:0.02em}" +
    "." +
    HEADER_ROOT_CLASS +
    ...
    "." +
    HEADER_ROOT_CLASS +
    "__nav{margin-left:auto;display:flex;gap:calc(1rem * var(--mpr-header-scale,1));align-items:center;font-size:calc(1rem * var(--mpr-header-scale,1))}" +
    "." +
    HEADER_ROOT_CLASS +
  ...
  var FOOTER_STYLE_MARKUP =
    ...
    '.mpr-footer__theme-toggle{display:inline-flex;align-items:center;gap:calc(0.6rem * var(--mpr-footer-scale,1));background:var(--mpr-theme-toggle-bg,rgba(148,163,184,0.15));border-radius:999px;padding:calc(0.35rem * var(--mpr-footer-scale,1)) calc(0.85rem * var(--mpr-footer-scale,1));color:var(--mpr-color-text-primary,#e2e8f0);font-size:calc(0.85rem * var(--mpr-footer-scale,1));cursor:pointer}' +
