 ...
 * The default `tauthUrl` points at the TAuth container from `docker-compose.yml`.
 * `tenantId` must match a tenant configured in `demo/tauth-config.yaml` (for the demo container this is `mpr-sites`).
 */
