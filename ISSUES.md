...
- [ ] [MU-206] Bundle the shared CSS with the mpr-ui package instead of hosting styles inside the demo. — Promote the demo stylesheet into the library bundle, ensure components auto-register the CSS (via ES module side-effect or documented import), and update the demo to import from the package.
