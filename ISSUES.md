...
- [ ] [MU-110] Refresh `demo/index.html` and supporting scripts to showcase web components end-to-end (header, footer, settings, sites) with realistic data and event logging so integrators can copy/paste working examples.
