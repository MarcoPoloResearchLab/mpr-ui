...
Replaced demo references with a self-contained fixture (`tests/e2e/fixtures/demo-workbench.html`), updated helpers/specs to use it, and removed the lingering `demo.css` dependency from the theme toggle fixture.
