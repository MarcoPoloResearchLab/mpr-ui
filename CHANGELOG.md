...
- MU-318: Header Settings control now opens a visible modal with default placeholder copy, clamps the overlay between the sticky header/footer, and ships Playwright coverage for both behaviours.
