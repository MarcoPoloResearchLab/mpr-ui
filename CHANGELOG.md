...
- MU-318: Header Settings control now opens a visible modal with default placeholder copy plus documentation hints so the panel no longer appears empty before custom UI mounts.
